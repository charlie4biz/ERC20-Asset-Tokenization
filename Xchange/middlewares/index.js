...
const { IsAuthenticated, IsAuditor, IsAdmin, IsApprover, IsSuperAdmin, IsActivated, IsWindowOpen } = require("./authentication")

module.exports = {
    ValidateCreateSchedule, ValidateUserLogin, SanitizeUserLogin, SanitizeCreateSchedule, ValidateUserLogout, SanitizeUserLogout, IsAuthenticated, IsAuditor, IsAdmin, IsApprover, IsSuperAdmin, IsActivated, IsWindowOpen, ValidateWallet, SanitizeWallet, ValidateFundWalletByAccount, ValidateUserFirstTimeLogin, ValidateFundWalletByCard, ValidateTransactionPin, SanitizeFundWallet, SanitizeTransactionPin, ValidateWalletCashout, ValidateSharePrice, ValidateUpdateSchedule, ValidateAddAccount
}