    ...
    */
    async CreateSchedule(req, res, next) {
        ...
        try {
            ...
            if (!allocationSchema[0].includes("USERNAME") || !allocationSchema[0].includes("VOLUME") || !allocationSchema[0].includes("CSCS") ) {
            ...
            if ( allocationSchema[0][1] != "USERNAME" || allocationSchema[0][2] != "VOLUME" || allocationSchema[0][3] != "CSCS") {
