...
exports.Errors = {
  ...
  SHAREAPPROVEDERR : "SHAREAPPROVED400",
  SHAREREJECTEDERR : "SHAREREJECTED400",
...
exports.GetCodeMsg = (errCode) => {
    ...
    switch (errCode) {
      ...
      case "FILEHEAD400":
        return "File content must contain fields 'USERNAME', 'VOLUME' and 'CSCS' as headings"
      case "FILEHEADARR400":
        return "File heading should have 'USERNAME' in cell B1, 'VOLUME' in cell C1 and 'CSCS' in cell D1"
      case "SCHAPPROVE400":
