...
router.get("/market/transactions", IsAuthenticated, IsAuditor, IsAdmin, MarketController.GetAllTradingTransactions);
...
router.post("/approver/approveSharePrice", IsAuthenticated, IsApprover, SettingController.ApproveSharePrice);

/**
 * Schedule Management
*/
router.get("/admin/schedules/allocation/:scheduleId?/:filter?", IsAuthenticated, IsAuditor, IsAdmin, ScheduleController.ScheduleAllocations);
router.get("/admin/schedules/single/:scheduleId?", IsAuthenticated, IsAuditor, IsAdmin, ScheduleController.SingleSchedule);
router.get("/admin/schedules/:filter?", IsAuthenticated, IsAuditor, IsAdmin, ScheduleController.AllSchedules);
